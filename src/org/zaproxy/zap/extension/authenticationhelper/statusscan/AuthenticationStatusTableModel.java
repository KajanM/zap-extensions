...
public class AuthenticationStatusTableModel
	...
	private static final String[] CUSTOM_COLUMN_NAMES = {
			Constant.messages.getString("authenticationhelper.table.authenticationStatus.header.status"),
			Constant.messages.getString("authenticationhelper.table.authenticationStatus.header.loggedInIndicator"),
			Constant.messages.getString("authenticationhelper.table.authenticationStatus.header.loggedOutIndicator") };
	...
	static {
		FAILED_STATUS_ICON = new ImageIcon(AuthenticationStatusTableModel.class
				.getResource("/org/zaproxy/zap/extension/authenticationhelper/resources/help/contents/images/cross-circle.png"));
		SUCCESSFULL_STATUS_ICON = new ImageIcon(AuthenticationStatusTableModel.class
				.getResource("/org/zaproxy/zap/extension/authenticationhelper/resources/help/contents/images/tick-circle.png"));
		CONFLICTING_STATUS_ICON = new ImageIcon(AuthenticationStatusTableModel.class
				.getResource("/org/zaproxy/zap/extension/authenticationhelper/resources/help/contents/images/exclamation-circle.png"));
		UNKNOWN_STATUS_ICON = new ImageIcon(AuthenticationStatusTableModel.class
				.getResource("/org/zaproxy/zap/extension/authenticationhelper/resources/help/contents/images/question-white.png"));

		FOUND_ICON = new ImageIcon(AuthenticationStatusTableModel.class
				.getResource("/org/zaproxy/zap/extension/authenticationhelper/resources/help/contents/images/tick.png"));
		NOT_FOUND_ICON = new ImageIcon(AuthenticationStatusTableModel.class
				.getResource("/org/zaproxy/zap/extension/authenticationhelper/resources/help/contents/images/cross.png"));
		NOT_DEFINED_ICON = new ImageIcon(AuthenticationStatusTableModel.class
				.getResource("/org/zaproxy/zap/extension/authenticationhelper/resources/help/contents/images/ash-circle.png"));
		COULD_NOT_VERIFY_ICON = new ImageIcon(AuthenticationStatusTableModel.class
				.getResource("/org/zaproxy/zap/extension/authenticationhelper/resources/help/contents/images/red-circle.png"));
	}
	...
	private Icon resolveAuthenticationStatusIcon(AuthenticationStatusTableEntry.AuthenticationStatus authenticationStatus) {
	...
	private Icon resolveIndicatorStatusIcon(AuthenticationStatusScanner.IndicatorStatus indicatorStatus) {
	...
	protected Object getCustomPrototypeValue(int columnIndex) {
		...
		throw new IllegalArgumentException("Custom column index should be either 0, 1 or 2, but got " + columnIndex);
	}

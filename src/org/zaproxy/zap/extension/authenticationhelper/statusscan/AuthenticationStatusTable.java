...
/**
 * A {@link HistoryReferencesTable} with additional columns to graphically
 * indicate authentication status of individual messages and information on
 * whether the provided logged in/out indicator presents in the response message or not
...
public class AuthenticationStatusTable extends HistoryReferencesTable {
	...
	public AuthenticationStatusTable(AuthenticationStatusTableModel resultsModel) {
		...
		getColumnExt(Constant.messages.getString("authenticationhelper.table.authenticationStatus.header.status")).setPreferredWidth(4);
		getColumnExt(Constant.messages.getString("authenticationhelper.table.authenticationStatus.header.loggedInIndicator")).setPreferredWidth(7);
		getColumnExt(Constant.messages.getString("authenticationhelper.table.authenticationStatus.header.loggedOutIndicator")).setPreferredWidth(7);
		getColumnExt(Constant.messages.getString("view.href.table.header.method")).setPreferredWidth(5);
		getColumnExt(Constant.messages.getString("view.href.table.header.code")).setPreferredWidth(5);

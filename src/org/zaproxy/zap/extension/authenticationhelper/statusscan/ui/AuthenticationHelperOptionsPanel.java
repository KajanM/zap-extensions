...
public class AuthenticationHelperOptionsPanel extends AbstractParamPanel {
	...
	public static final String PANEL_NAME = Constant.messages.getString("authenticationhelper.options.title");
	...
	private void initialize() {
        ...
        add(new JLabel(Constant.messages.getString("authenticationhelper.options.regex.label")), gbc);

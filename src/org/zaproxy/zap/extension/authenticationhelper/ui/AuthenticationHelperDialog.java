...
import org.zaproxy.zap.extension.authenticationhelper.ui.AuthenticationConfigurationChecklistPanel.ConfigurationStatus;
	...
	public JButton[] getExtraButtons() {
		if (extraButtons == null) {
			...
			refreshButton.addActionListener(e -> {
				getChecklistPanel().setAppropriateToolTipAndActionListener();

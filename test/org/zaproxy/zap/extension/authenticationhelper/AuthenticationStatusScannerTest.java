...
public class AuthenticationStatusScannerTest {
	...
	public void shouldThrowIllegalArgumentExceptionIfBothIndicatorsAreNotDefined() {
		...
		exceptionRule.expectMessage("atleast one of logged in or logged out indicator should be defined");
	...
	private void assertStatus(
		...
		assertEquals("inIndicator -> " + inIndicator + ", outIndicator -> " + outIndicator,
				expectedAuthStatus, actualAuthStatus);
	}
	//@formatter:on
